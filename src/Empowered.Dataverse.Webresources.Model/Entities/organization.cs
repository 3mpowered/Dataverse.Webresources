...
namespace Empowered.Dataverse.Webresources.Model
{
	...
	public partial class Organization : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Webresources.Model.Publisher> organization_publisher
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Webresources.Model.Publisher>("organization_publisher", null);
			}
			set
			{
				this.SetRelatedEntities<Empowered.Dataverse.Webresources.Model.Publisher>("organization_publisher", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Webresources.Model.Solution> organization_solution
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Webresources.Model.Solution>("organization_solution", null);
			}
			set
			{
				this.SetRelatedEntities<Empowered.Dataverse.Webresources.Model.Solution>("organization_solution", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Webresources.Model.SystemUser> organization_system_users
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Webresources.Model.SystemUser>("organization_system_users", null);
			}
			set
			{
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser lk_organization_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("lk_organization_createdonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser lk_organization_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("lk_organization_modifiedonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser lk_organizationbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("lk_organizationbase_createdby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser lk_organizationbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("lk_organizationbase_modifiedby", null);
			}
		}
	}
}
