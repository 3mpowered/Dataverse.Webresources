...
namespace Empowered.Dataverse.Webresources.Model
{
	...
	public partial class WebResource : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Empowered.Dataverse.Webresources.Model.Solution> solution_configuration_webresource
		{
			get
			{
				return this.GetRelatedEntities<Empowered.Dataverse.Webresources.Model.Solution>("solution_configuration_webresource", null);
			}
			set
			{
				this.SetRelatedEntities<Empowered.Dataverse.Webresources.Model.Solution>("solution_configuration_webresource", null, value);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser lk_webresourcebase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("lk_webresourcebase_createdonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser lk_webresourcebase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("lk_webresourcebase_modifiedonbehalfby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser webresource_createdby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("webresource_createdby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.SystemUser webresource_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.SystemUser>("webresource_modifiedby", null);
			}
		}
		...
		public Empowered.Dataverse.Webresources.Model.Organization webresource_organization
		{
			get
			{
				return this.GetRelatedEntity<Empowered.Dataverse.Webresources.Model.Organization>("webresource_organization", null);
			}
		}
	}
}
